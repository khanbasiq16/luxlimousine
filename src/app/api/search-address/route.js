...
const BASE_MAPBOX_URL = "https://api.mapbox.com/search/geocode/v6/forward";
...
export async function GET(request) {
  ...
  // Geocoding v6 Forward API
  const url = `${BASE_MAPBOX_URL}?q=${encodeURIComponent(
    searchText
  )}&language=en&limit=10&country=AU&access_token=${process.env.MAPBOX_ACCESS_TOKEN}`;
